...
function setupToggle(btn, textElement, shortText, longText){
  textElement.textContent = shortText;
  let shortHeight = textElement.scrollHeight + "px";
  textElement.style.maxHeight = shortHeight;
...
const toggleBtnAbout = document.getElementById('toggle-btn-about');
// Usage for About section
setupToggle(toggleBtnAbout, aboutText, shortText, longText);
...
// Usage for Web Development section
setupToggle(webBtn, webText, web_shortText, web_longText);
...
// Usage for UI/UX section
setupToggle(uiBtn, uiText, ui_shorText, ui_longText);
